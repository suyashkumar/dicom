...
func fakeHeader_NoFileMetaInformationGroupLength() *bytes.Buffer {
	preamble := make([]byte, 128)
	// First element after DICM is (0x0002,0x0002)
	data := []byte{
		,
	}
	data = append(preamble, data...)
	dcm_header := bytes.NewBuffer(data)
	return dcm_header
}

// Returns a fake DICOM group 2 header with a FileMetaInformationGroupLength tag (0x0002,0x0000)
func fakeHeader_WithFileMetaInformationGroupLength() *bytes.Buffer {
	preamble := make([]byte, 128)
	// First element after DICM is (0x0002,0x0000)
	data := []byte{
		,
	}
	data = append(preamble, data...)
	dcm_header := bytes.NewBuffer(data)
	return dcm_header
...
func TestReadHeader_TryAllowErrorMetaElementGroupLength(t *testing.T) {
	...
	dcmheader_noinfogrplen := fakeHeader_NoFileMetaInformationGroupLength()
	...
	// -------------
	dcmheader_infogrplen := fakeHeader_WithFileMetaInformationGroupLength()
	r = &reader{
